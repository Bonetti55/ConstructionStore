...
var connectionString = builder.Configuration.GetConnectionString("Constructions") ?? "Data Source=Constructions.db";

builder.Services.AddEndpointsApiExplorer();
builder.Services.AddSqlite<ConstructionDb>(connectionString);
